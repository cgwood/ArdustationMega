...
// Navigation Tuning Parameters Page
class PagePlaneParametersNTUN :
public Pages {
public:
  PagePlaneParametersNTUN();
...
private:
  ...
  /// Availability of paramter values
  bool            _avail[PARAM_COUNT_PLANE_NTUN];
...
protected:
  ...
  /// Types to be displayed (in same order as _textHeader)
  uint8_t   _Types[PARAM_COUNT_PLANE_NTUN];
...
// TECS Tuning Parameters Page
class PagePlaneParametersTECS :
public Pages {
public:
  PagePlaneParametersTECS();
...
private:
  ...
  /// Availability of paramter values
  bool            _avail[PARAM_COUNT_PLANE_TECS];
...
protected:
  ...
  /// Types to be displayed (in same order as _textHeader)
  uint8_t   _Types[PARAM_COUNT_PLANE_TECS];
